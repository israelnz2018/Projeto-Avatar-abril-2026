...
const SEMANAS: Semana[] = [
  ...
  { fase: 'f1', sw: 'Sem 2', titulo: 'Organograma e pessoas-chave', dias: [
    ...
    { d: 'Dia 8', txt: 'Identifiquei a pessoa que mais domina o processo (meu "atalho")' },
  ...
  { fase: 'f1', sw: 'Sem 3', titulo: 'Mapa do processo e RACI', dias: [
    { d: 'Dia 11', txt: 'Mapeei o fluxo do processo principal, do início ao fim' },
    { d: 'Dia 12', txt: 'Marquei os pontos onde o processo costuma travar ou atrasar' },
  ...
  { fase: 'f1', sw: 'Sem 4', titulo: 'Indicadores: técnicos, estratégicos e operacionais', dias: [
    ...
    { d: 'Dia 20', txt: 'Consigo explicar como a área funciona em 2 minutos — Fase 1 concluída' },
  ]},
