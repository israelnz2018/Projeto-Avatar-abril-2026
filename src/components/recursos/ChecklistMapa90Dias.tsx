...
const SEMANAS: Semana[] = [
  { fase: 'f1', sw: 'Sem 1', titulo: 'POP e SIPOC — o que a área faz', dias: [
    ...
    { d: 'Dia 3', txt: 'Mapeei as Entradas e Saídas das principais atividades (o que entra, o que sai)' },
    { d: 'Dia 4', txt: 'Identifiquei Fornecedores e Clientes das principais saídas (SIPOC completo)' },
  ...
  { fase: 'f1', sw: 'Sem 2', titulo: 'Organograma e pessoas-chave', dias: [
    ...
    { d: 'Dia 7', txt: 'Marquei quem decide, quem aprova e quem executa' },
  ...
  { fase: 'f1', sw: 'Sem 3', titulo: 'Mapa do processo e RACI', dias: [
    { d: 'Dia 11', txt: 'Mapeei o fluxo dos principais processos, do início ao fim' },
    { d: 'Dia 12', txt: 'Marquei os pontos onde os processos costumam travar ou atrasar' },
    { d: 'Dia 13', txt: 'Listei as atividades que precisam de responsável claro' },
    { d: 'Dia 14', txt: 'Preenchi a matriz RACI (Responsável, Aprovador, Consultado, Informado)' },
    { d: 'Dia 15', txt: 'Validei o mapa e o RACI com alguém experiente da área' },
  ]},
  { fase: 'f1', sw: 'Sem 4', titulo: 'Indicadores: técnicos, estratégicos e operacionais', dias: [
    { d: 'Dia 16', txt: 'Levantei os indicadores operacionais (o dia a dia da área)' },
    { d: 'Dia 17', txt: 'Levantei os indicadores técnicos (qualidade, tempo, retrabalho)' },
    { d: 'Dia 18', txt: 'Entendi os indicadores estratégicos (o que a diretoria acompanha)' },
    { d: 'Dia 19', txt: 'Descobri quais indicadores estão ruins ou sem meta' },
  ...
  { fase: 'f2', sw: 'Sem 5', titulo: 'Ideias de projetos de melhoria', dias: [
    ...
    { d: 'Dia 25', txt: 'Cheguei a uma lista de 5 a 10 ideias de projeto' },
  ]},
  ...
  { fase: 'f2', sw: 'Sem 7', titulo: 'Detalhamento do projeto de melhoria', dias: [
    { d: 'Dia 31', txt: 'Escrevi o problema em uma frase clara (o quê, onde, desde quando)' },
  ...
  { fase: 'f3', sw: 'Sem 9', titulo: 'Analisando e identificando as causas raízes (software LBW)', dias: [
    { d: 'Dia 41', txt: 'Montei o diagrama de Ishikawa das possíveis causas' },
    { d: 'Dia 42', txt: 'Apliquei os 5 Porquês para ir além da primeira causa' },
    { d: 'Dia 43', txt: 'Usei o software LBW para analisar os dados coletados' },
  ...
  { fase: 'f3', sw: 'Sem 10', titulo: 'Identificando as melhores soluções', dias: [
    ...
    { d: 'Dia 47', txt: 'Avaliei as soluções por esforço × impacto' },
  ...
  { fase: 'f3', sw: 'Sem 11', titulo: 'Implementação do plano de ação', dias: [
    { d: 'Dia 51', txt: 'Montei o plano de ação (o quê, quem, quando — 5W2H)' },
  ...
  { fase: 'f3', sw: 'Sem 12', titulo: 'Apresentando os resultados (PPT gerado)', dias: [
    { d: 'Dia 56', txt: 'Montei a comparação ANTES × DEPOIS com números' },
    ...
    <div style={{ border: '3px double #1E2D6E', borderRadius: 6, background: '#fff', overflow: 'hidden' }}>
      <div style={{ border: '1px solid #dfe4f0', margin: 6, borderRadius: 3 }}>
        ...
        <div style={{ margin: '6px 24px 16px', fontSize: 11, fontStyle: 'italic', color: '#1E2D6E', borderLeft: '3px solid #0033CC', padding: '7px 14px', background: '#F0F2FA', borderRadius: '0 8px 8px 0', lineHeight: 1.4 }}>
          Isso não é um certificado na parede. É a prova de que, enquanto a maioria passou 90 dias "tentando entender", você entendeu, agiu e entregou.
        </div>
      </div>
    </div>
  );
