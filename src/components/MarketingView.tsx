...
import { Megaphone, RefreshCw, CheckCircle2, AlertTriangle, Users } from 'lucide-react';
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <p className="text-xs text-gray-400 mt-6 leading-relaxed">
        Os novos cadastros são adicionados automaticamente ao Reach no momento da inscrição.
        Esta tela serve pra subir os contatos que já existiam e conferir a conexão.
        As campanhas e a newsletter semanal você cria dentro do painel do Hostinger Reach.
      </p>
    </div>
  );
}
