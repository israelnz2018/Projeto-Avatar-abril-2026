  ...
  return (
    <div className="consultores-lp consultores-lp-nova">
      ...
      <main>
        ...
        <section className="consultores-section authority-section"><div className="consultores-container authority-grid"><Reveal className="authority-photo"><img src="/israel-foto.png" alt="Israel Souza" /></Reveal><Reveal className="authority-copy" delay={0.1}><span className="section-kicker">Experiência prática</span><h2>Uma estrutura criada por quem viveu a melhoria na prática.</h2><p>Mais de 20 anos trabalhando com processos, projetos, treinamentos e desenvolvimento de pessoas em diferentes contextos. A LBW reúne essa experiência em uma plataforma para outros consultores entregarem melhor.</p><div className="authority-numbers"><div><strong>20+</strong><span>anos de experiência</span></div><div><strong>1.500+</strong><span>profissionais treinados</span></div><div><strong>US$ 20MM+</strong><span>em ganhos com projetos</span></div></div></Reveal></div></section>
