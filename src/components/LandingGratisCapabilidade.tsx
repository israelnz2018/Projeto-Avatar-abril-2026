...
const SELECT_STYLE: React.CSSProperties = {
  ...
  border: '1px solid rgba(148,163,184,.3)', background: '#0b1426', color: '#fff', fontSize: 14, height: 58, boxSizing: 'border-box',
};
    ...
    try {
      const response = await fetch('/api/public/acesso-gratis', {
        ...
        body: JSON.stringify({
          ...
          interesseCursos: cursosInteresseSelecionados,
          codigoPais,
          whatsappNumero: numeroWhatsapp,
          aceitouTermos,
          termosVersao: TERMOS_GRATUITOS_VERSAO,
        }),
      });
