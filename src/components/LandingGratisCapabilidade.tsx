...
export default function LandingGratisCapabilidade() {
  ...
  const selecionarCursoNoDropdown = (curso: string, event: React.ChangeEvent<HTMLInputElement>) => {
