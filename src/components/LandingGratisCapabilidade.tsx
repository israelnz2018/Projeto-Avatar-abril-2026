...
.lgc .brand{text-align:center}.lgc .hero{padding:34px 0 42px}.lgc .hero-grid{grid-template-columns:1.18fr .72fr .92fr;gap:24px;align-items:center}.lgc h1{font-size:clamp(34px,3.8vw,48px);margin:16px 0 14px}.lgc .lead{font-size:16px;line-height:1.48;margin-bottom:18px}.lgc .visual{padding:18px}.lgc .gauge{height:190px}.lgc .circle{width:142px;height:142px;border-width:15px}.lgc .circle b{font-size:30px}.lgc .metric{padding:10px 0;font-size:12px;gap:8px}.lgc .metric strong{text-align:right}.lgc .hero .form-box{height:100%;padding:22px}.lgc .hero .form-box h3{font-size:21px}.lgc .hero .form-box p{font-size:13px;margin-bottom:14px}.lgc .hero .form-box input{padding:12px 13px;margin-bottom:9px;font-size:14px}.lgc .hero .form-box .cta{padding:14px 16px;font-size:14px}.lgc .hero .form-box .note{font-size:11px}.lgc .hero-form{height:100%}
  ...
  return <div className="lgc"><style>{CSS}</style>
    ...
    <main>
      <section className="hero"><div className="wrap hero-grid">
        ...
        <div className="visual"><div className="gauge"><div className="circle"><b>Cp<br/>Cpk</b></div></div><div className="metric"><span>Curso</span><strong>Capabilidade de Processo</strong></div><div className="metric"><span>Data Analysis</span><strong>Capabilidade</strong></div><div className="metric"><span>Mentor</span><strong>IA do Israel</strong></div></div>
