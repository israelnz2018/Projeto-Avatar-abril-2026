...
export default function LandingGratisCapabilidade() {
  ...
  return <div className="lgc"><style>{CSS}</style><style>{'.lgc .hero-form details{border:0;padding:0;background:transparent;border-radius:0}.lgc .hero-form form > .cta{margin-top:11px}'}</style>
