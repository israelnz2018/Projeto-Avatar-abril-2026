...
export default function LandingGratisCapabilidade() {
  ...
  const enviar = async (event: React.FormEvent) => {
    ...
    if (!cursoInteresse) { setState('err'); setMessage('Escolha outro curso ou selecione “Nenhum curso”.'); return; }
