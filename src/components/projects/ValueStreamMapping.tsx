...
export default function ValueStreamMapping({ onSave, initialData, onGenerateAI, isGeneratingAI, onClearAIData }: ValueStreamMappingProps) {
  ...
  const isToolEmpty = steps.length === 0 || (steps.length === 1 && !steps[0].name);
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                A IA analisará o escopo e o SIPOC para sugerir as etapas do fluxo de valor, tempos de ciclo e espera.
              </p>
              <p className="text-xs text-blue-500 font-bold mt-2 italic">
                * A IA vai mapear as principais etapas e sugerir tempos estimados baseados no tipo de processo.
              </p>
            </div>
            <button
