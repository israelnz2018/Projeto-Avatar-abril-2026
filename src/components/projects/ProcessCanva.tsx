...
import { 
  ...
  User, Users, Play, Square, GitBranch, Monitor, Target, Save, Edit3, Sparkles, Loader2
} from 'lucide-react';
...
export default function ProcessCanva({ onSave, initialData, onGenerateAI, isGeneratingAI, onClearAIData }: ProcessCanvaProps) {
  ...
  const isToolEmpty = !data.form.processName && data.form.steps.length <= 1 && !data.form.processObjective;
