    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="bg-white border border-[#ccc] rounded-[8px] shadow-sm overflow-hidden">
        ...
        <div className="p-6 overflow-x-auto">
          <table className="w-full text-left border-collapse min-w-[1000px] tool-table">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-200">
                <ResizableHeader initialWidth={250} minWidth={150} className="p-3 text-xs font-bold text-gray-600 uppercase whitespace-normal break-words">Nome / Área</ResizableHeader>
                <ResizableHeader initialWidth={250} minWidth={150} className="p-3 text-xs font-bold text-gray-600 uppercase whitespace-normal break-words">Função no Projeto</ResizableHeader>
                <ResizableHeader initialWidth={150} minWidth={100} className="p-3 text-xs font-bold text-gray-600 uppercase whitespace-normal break-words">Poder</ResizableHeader>
                <ResizableHeader initialWidth={150} minWidth={100} className="p-3 text-xs font-bold text-gray-600 uppercase whitespace-normal break-words">Interesse</ResizableHeader>
                <ResizableHeader initialWidth={180} minWidth={100} className="p-3 text-xs font-bold text-gray-600 uppercase whitespace-normal break-words">Engajamento Atual</ResizableHeader>
                <th className="p-3 text-xs font-bold text-gray-600 uppercase w-[80px] text-center whitespace-normal break-words">Ações</th>
              </tr>
            </thead>
            <tbody>
