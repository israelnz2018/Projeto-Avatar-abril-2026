...
const T1: QuizQuestion[] = [
  ...
  q('t1-7', 'A matriz Esforço × Benefício ajuda a:', ['Calcular o desvio padrão', 'Priorizar ações comparando o esforço necessário com o benefício esperado', 'Mapear stakeholders', 'Medir a satisfação do cliente'], 1),
